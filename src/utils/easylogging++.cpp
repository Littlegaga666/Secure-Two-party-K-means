 ...
 * \author  Bismillah ar-Rahmaan ar-Raheem
 * \version Easylogging++ v9.96.7
 * \brief   Cross-platform logging library for C++ applications
 * \copyright   Copyright (c) 2012-2018 Zuhd Web Services
