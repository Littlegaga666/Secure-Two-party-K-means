...
//    printf("\nm_vInputShareSndBuf: %lu\n", m_vOutputShareSndBuf.GetArr());
//    printf("m_vOutputShareSndBuf: %lu\n", m_vOutputShareSndBuf.GetArr());
//    printf("m_vInputShareRcvBuf: %lu\n", m_vInputShareRcvBuf.GetArr());
//    printf("m_vOutputShareRcvBuf: %lu\n", m_vOutputShareRcvBuf.GetArr());
